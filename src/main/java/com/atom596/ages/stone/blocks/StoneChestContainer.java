...
import com.atom596.ages.stone.subscribers.BlockSubscriber;
import com.atom596.ages.stone.subscribers.ContainerSubscriber;
import com.atom596.ages.stone.utils.ContainerUtils;
...
import static com.atom596.ages.stone.blocks.StoneChestTileEntity.INVENTORY_HEIGHT;
import static com.atom596.ages.stone.blocks.StoneChestTileEntity.INVENTORY_WIDTH;
...
public class StoneChestContainer extends Container {
    ...
    public StoneChestContainer(int windowId, @Nonnull PlayerInventory inv, @Nonnull PacketBuffer extraData) {
        this(windowId, extraData.readBlockPos(), Objects.requireNonNull(AgesMod.proxy.getClientWorld()), inv, Objects.requireNonNull(AgesMod.proxy.getClientPlayer()));
    }
